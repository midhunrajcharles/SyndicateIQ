import { LoanDocument, CovenantMonitoring, ESGMetrics } from '../types/syndicateiq';
...
export const sampleLoans: LoanDocument[] = [
  {
    ...
    covenants: {
      financial: [
        { type: 'Debt/EBITDA', limit: '< 3.0x', currentValue: '2.4x', frequency: 'Quarterly' },
        { type: 'Interest Coverage', limit: '> 4.0x', currentValue: '5.2x', frequency: 'Quarterly' }
      ],
      reporting: [
        { type: 'Financial Statements', frequency: 'Quarterly', deadline: '45 days after quarter end' },
        { type: 'ESG Report', frequency: 'Annual', deadline: '90 days after year end' }
      ]
    },
    esgObligations: {
  ...
  },
  {
    ...
    covenants: {
      financial: [
        { type: 'Debt/EBITDA', limit: '< 3.5x', currentValue: '3.2x', frequency: 'Quarterly' }
      ],
      reporting: [
        { type: 'Financial Statements', frequency: 'Quarterly', deadline: '45 days after quarter end' }
      ]
...
export const sampleCovenantMonitoring: CovenantMonitoring[] = [
  {
    ...
    covenants: [
      { type: 'Debt/EBITDA', currentValue: 2.4, limit: 3.0, cushion: 20, trend: 'stable' }
    ],
    riskScore: 35,
  ...
  },
  {
    ...
    covenants: [
      { type: 'Debt/EBITDA', currentValue: 3.2, limit: 3.5, cushion: 8.6, trend: 'deteriorating' }
    ],
    riskScore: 78,
