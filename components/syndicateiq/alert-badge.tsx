...
export function AlertBadge({ severity, message, timestamp }: AlertBadgeProps) {
  const config = {
    info: {
      icon: Info,
      bgColor: 'bg-blue-50',
  ...
  return (
    <div className={`${bgColor} ${borderColor} border-l-4 p-4 rounded transition-all hover:shadow-md`}>
